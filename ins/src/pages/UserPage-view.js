...
class UserPageView extends Component {
    ...
    handleDelete = (e) => {
        ...
        if (pid) {
            ...
            this.props.firebase.db.ref('/posts/' + pid).remove();

            this.props.firebase.db.ref('/user-posts/' + authUser.uid + '/' + pid).remove();

            const desertRef = this.props.firebase.storage.ref(`images/${name}`);

            desertRef.delete().then(function () {
                console.log('Image in storage has been deleted.')
                                ...
                                <div className="row center">
                                    ...
                                    <div className="card-action col right">
                                        <button className="btn-flat" onClick={this.handleDelete}>
                                            <i className="material-icons red-text" id={postKey} name={posts[postKey].imageName}>
                                                delete
                                            </i>
                                        </button>
                                    </div>
